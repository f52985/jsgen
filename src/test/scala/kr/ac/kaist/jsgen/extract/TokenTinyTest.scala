...
import kr.ac.kaist.jsgen.spec.algorithm.token._
import kr.ac.kaist.jsgen.extractor.algorithm._
import scala.util.Random
import org.scalatest._

class TokenTinyTest extends ExtractTest {
  val name: String = "extractTokenTest"
